            ...
            <div className="container">
                ...
                >
                    ...
                    <div className="privacy-section">
                        <h2>Introduction</h2>
                        <p>This website is operated by Cybrion Consulting. We are committed to respecting your privacy and ensuring that any personal information shared with us is handled responsibly and lawfully.</p>
                    ...
                    <div className="privacy-section">
                        ...
                        <p>Cybrion Consulting follows reasonable security practices and procedures to protect personal information from unauthorised access, misuse, alteration or disclosure.</p>
                    ...
                    <div className="privacy-section">
                        ...
                        <p>This website may contain links to external websites for reference or convenience. Cybrion Consulting is not responsible for the content or privacy practices of third party websites. Users should review the privacy policies of such websites independently.</p>
                    </div>
                    ...
                    <div className="privacy-section">
                        ...
                        <p>All content on this website, including text and branding, is the property of Cybrion Consulting unless otherwise stated. Unauthorised use, reproduction or distribution is prohibited.</p>
                    </div>

                    <div className="privacy-section">
                        <h2>Limitation of Liability</h2>
                        <p>Cybrion Consulting shall not be liable for any direct or indirect loss arising from the use of this website or reliance on its content, to the extent permitted under Indian law.</p>
                    </div>
